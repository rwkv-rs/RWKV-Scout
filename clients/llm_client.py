    ...
    def _record_backend_response(
        ...
        *,
        ...
        payload = {
            ...
            "request_stage": get_model_request_stage(),
            "sampling_policy_reason": get_sampling_policy_reason(),
            "sampling_parameters": get_llm_sampling_parameters(),
