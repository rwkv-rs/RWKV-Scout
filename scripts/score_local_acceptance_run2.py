"""Apply the frontend acceptance formulas to one recorded local run."""
...
def main() -> int:
    ...
    for row in payload.get("results", []):
        ...
        rows.append({
            ...
            "navigation_leakage": bool(re.search(r"(?:鎼滅储妗唡鐧诲綍|娉ㄥ唽|涓嬩竴椤祙鑿滃崟|瀵艰埅)", answer)),
    ...
    output = run_path.with_suffix(".exact-metrics.json")
